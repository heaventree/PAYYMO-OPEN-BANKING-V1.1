...
def upgrade():
    ...
    if 'whmcs_instances' not in existing_tables:
    ...
    if 'stripe_connections' not in existing_tables:
    ...
    if 'stripe_payments' not in existing_tables:
    ...
    if 'invoice_matches' not in existing_tables:
    ...
    if 'stripe_invoice_matches' not in existing_tables:
    ...
    try:
        if 'license_keys' in existing_tables:
        ...
        if 'bank_connections' in existing_tables:
        ...
        if 'stripe_connections' in existing_tables:
        ...
        if 'stripe_payments' in existing_tables:
        ...
        if 'invoice_matches' in existing_tables:
        ...
        if 'stripe_invoice_matches' in existing_tables:
        ...
        # Log the error but continue - index errors shouldn't stop the migration
