...
@pages.route('/pages/profile_settings')
@login_required
def pages_profile_settings():
    return render_template('pages/pages-profile-settings.html')

@pages.route('/pages/contacts')
@login_required
def pages_contacts():
    return render_template('pages/pages-contacts.html')
...
@login_required
def pages_privacy_policy():
    return render_template('pages/pages-privacy-policy.html')

@pages.route('/pages/term_conditions')
@login_required
def pages_term_conditions():
    return render_template('pages/pages-term-conditions.html')
