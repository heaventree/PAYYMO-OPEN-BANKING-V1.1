<?php
/**
 * Payymo - Financial Payments Integration Module for WHMCS
 *
 ...
 * @return array
 */
function payymo_config() {
    return [
        'name' => 'Payymo Financial Toolbox',
        'description' => 'Complete financial toolbox integrating both GoCardless Open Banking and Stripe for automated transaction retrieval and invoice reconciliation.',
        'author' => 'Payymo',
        'language' => 'english',
        'version' => '1.0',
        'fields' => [
 ...
 * @return array
 */
function payymo_activate() {
    try {
        // Create transactions table
        if (!Capsule::schema()->hasTable('mod_payymo_transactions')) {
            Capsule::schema()->create('mod_payymo_transactions', function ($table) {
                $table->increments('id');
